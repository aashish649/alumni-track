...
import { signup,login,userloggedin,userlogged,logout,getUserData,localfileupload,imageUpload,updateProfile,searchUser,getUser,userProfile,askQuestion,allques, allnotice,resetPassword,forgotPassword,changePassword,userPassword } from "../controllers/userAuth.js";
import { adminSignup,adminLogin,adminLoggedIn,verifyEmail,Adminlogout,unanswered,answer,deleteQuestion,searchAdmin,deleteUser,sendMail,uploadNotice,upload,resetAdminPass,verifyOtp,changeAdminPass} from "../controllers/adminAuth.js";
import  {authUser}  from "../middlewares/authUserMiddle.js";
import { authAdmin } from "../middlewares/authAdminMiddle.js";
import { createPost,deletePost,like,disLikes,createComment,getPost,getAllPosts,cloudinaryUpload } from "../controllers/postController.js";
...
userRouter.post("/:user_id/localfileupload", authUser, localfileupload);
userRouter.post("/:user_id/imageUpload", authUser, imageUpload);
...
export { userRouter, adminRouter,postRouter};
