...
const Header = () => {
  ...
  return (
    <>
    <nav className="bg-gray-800 p-5 box-border sticky top-0 z-50 mt-1 ml-1 mr-1 rounded-lg border-blue-400">
      <div className="container mx-auto flex justify-between items-center max-w-screen-xl">
        ...
        >
          ...
          <Link to="/about-us" className="block px-4 py-2 hover:text-blue-500">
            About Us
          </Link>
          <Link
            to="/login"
